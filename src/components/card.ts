...
export class Card extends LitElement {
  ...
  toggle() {
    console.log(document.getElementById("dropdownBillingInfoButton"));
  }
            ...
            (companyData, index) =>
              html`
                ...
                <div class='card-text mb-2'>
                  ...
                  <i class='far fa-copy' @click=${() => copyToClipboard(this, "iban" + index)} aria-hidden='true'></i>
                </div>
                <div class='card-text mb-2'>
                  <strong class='me-1'>Swift code:</strong>
                  <span id='swift${index}' class='me-3'>swift123456</span>
                  <i class='far fa-copy' @click=${() => copyToClipboard(this, "swift" + index)} aria-hidden='true'></i>
                </div>
                <div class='card-text mb-2'>
                  <strong class='me-1'>Paypal:</strong>
                  <span id='paypal${index}' class='me-3'> paypal@paypal.com</span>
                  <i class='far fa-copy' @click=${() => copyToClipboard(this, "paypal" + index)} aria-hidden='true'></i>
                </div>
